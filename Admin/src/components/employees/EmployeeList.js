...
class EmployeeList extends Component {
  ...
  render() {
    ...
    const headers = [
      {
        id: 0,
        title: intl.formatMessage({id: 'table.header.employeeId'})
      },
      {
        id: 1,
        title: intl.formatMessage({id: 'table.header.employeeName'})
      },
      {
        id: 2,
        title: intl.formatMessage({id: 'table.header.edit.rush'})
      },
      {
        id: 3,
        title: intl.formatMessage({id: 'table.header.edit.staff'})
      },
      {
        id: 4,
            ...
            {rows.map((row, key) => {
              return (
                <StyledTableRow
                  ...
                  <StyledTableCell style={{minWidth: 400}}>{row.emp_name}</StyledTableCell>
                  <StyledTableCell>
                    <p className="gx-text-primary gx-pointer gx-mb-0" type="primary"
                       onClick={() => this.props.onClickRushEditButton(row.id)}>
                      <FormattedMessage id="btn.edit"/>
                    </p>
                  </StyledTableCell>
                  <StyledTableCell>
                    <p className="gx-text-primary gx-pointer gx-mb-0" type="primary"
                       onClick={() => this.props.onClickStaffEditButton(row.id)}>
                      <FormattedMessage id="btn.edit"/>
                    </p>
                  </StyledTableCell>
                  <StyledTableCell>
...
export default withStyles(styles)(injectIntl(EmployeeList))
