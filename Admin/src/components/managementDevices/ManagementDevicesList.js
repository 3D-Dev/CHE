...
class ManagementDevicesList extends Component {
  ...
  render() {
    ...
    const headers = [
      {
        id: 0,
        title: intl.formatMessage({id: 'table.header.managementDevicesId'})
      },
      {
        id: 1,
        title: intl.formatMessage({id: 'table.header.managementDevicesMaker'})
      },
      {
        id: 2,
        title: intl.formatMessage({id: 'table.header.managementDevicesCategory'})
      },
      {
        id: 3,
        title: intl.formatMessage({id: 'table.header.managementDevicesCommonName'})
      },
      {
        id: 4,
      ...
      {
        id: 5,
        title: intl.formatMessage({id: 'table.header.delete'})
      }
    ]
    return (
            ...
            {rows.map((row, key) => {
              return (
                <StyledTableRow
                  ...
                  <StyledTableCell>{row.makerCd}</StyledTableCell>
                  <StyledTableCell>{row.machineType}</StyledTableCell>
                  <StyledTableCell>{row.machine_type_input}</StyledTableCell>
                  <StyledTableCell>
                  ...
                  <StyledTableCell>
                    <p className="gx-text-red gx-pointer gx-mb-0"
                       onClick={() => this.props.onClickDeleteButton(row.id)}>
...
export default withStyles(styles)(injectIntl(ManagementDevicesList))
