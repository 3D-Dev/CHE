...
class ImportantCategoriesList extends Component {
  ...
  render() {
    ...
    const headers = [
      {
        id: 0,
        title: intl.formatMessage({id: 'table.header.importantCategoryId'})
      },
      {
        id: 1,
        title: intl.formatMessage({id: 'table.header.importantCategoryMenu'})
      },
      {
        id: 2,
            ...
            {rows.map((row, key) => {
              return (
                <StyledTableRow
                  ...
                  <StyledTableCell>{row.bunrui_name}</StyledTableCell>
                  <StyledTableCell>
...
export default withStyles(styles)(injectIntl(ImportantCategoriesList))
