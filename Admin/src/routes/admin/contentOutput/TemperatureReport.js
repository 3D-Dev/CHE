...
import { TemperatureReportList } from '../../../components'
import { getTemperatureReport } from '../../../api/axiosAPIs'
...
class TemperatureReport extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.setTitleText(intl.formatMessage({id: `btn.contents.temperature`}))
  ...
  fetchData(date) {
    ...
    getTemperatureReport(date.getFullYear(), date.getMonth() + 1)
      .then(response => {
            ...
            <div className="gx-flex-row gx-align-items-center gx-mb-4">
              <div
                ...
                <Space>
                  ...
                  <h2 className="gx-w-60"><FormattedMessage id="btn.contents.temperature"/></h2>
                </Space>
              </div>
              <div
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(TemperatureReport))
