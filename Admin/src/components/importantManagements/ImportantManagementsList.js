...
class ImportantManagementsList extends Component {
  ...
  render() {
    ...
    const headers = [
      {
        id: 0,
        title: intl.formatMessage({id: 'table.header.importantManagementId'})
      },
      {
        id: 1,
        title: intl.formatMessage({id: 'table.header.importantManagementMenu'})
      },
      {
        id: 2,
        title: intl.formatMessage({id: 'table.header.importantManagementSort'})
      },
      {
        id: 3,
        title: intl.formatMessage({id: 'table.header.importantManagementMethod'})
      },
      {
        id: 4,
            ...
            {rows.map((row, key) => {
              return (
                <StyledTableRow
                  ...
                  <StyledTableCell>{row.menu_content}</StyledTableCell>
                  <StyledTableCell>{row.sort}</StyledTableCell>
                  <StyledTableCell>{row.chk_content}</StyledTableCell>
                  <StyledTableCell>
...
export default withStyles(styles)(injectIntl(ImportantManagementsList))
