...
class CustomerList extends Component {
  ...
  render() {
    ...
    const headers = [
      {
        id: 0,
        title: intl.formatMessage({id: 'table.header.customerId'})
      },
      {
        id: 1,
        title: intl.formatMessage({id: 'table.header.customerName'})
      },
      {
        id: 2,
                ...
                <StyledTableRow
                  ...
                  <StyledTableCell align="center">
                    <Button className="gx-mb-0 gx-btn-rounded-blue1" type="primary"
                            onClick={() => this.props.onClickGoDashboardLogin(row.id)}>
                      <FormattedMessage id="btn.goDashboardLogin"/>
                    </Button>
                  </StyledTableCell>
                </StyledTableRow>
              )
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(injectIntl(CustomerList)))
