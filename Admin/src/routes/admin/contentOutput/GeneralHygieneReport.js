...
import { HygieneList } from '../../../components'
import { getGeneralHygieneReport } from '../../../api/axiosAPIs'
import _ from 'lodash'
import PageConstant from '../../../constants/PageConstant'
import { Button, Card, Select, Space, Spin } from 'antd'
import { setTitleText } from '../../../appRedux/actions/Custom'

class GeneralHygieneReport extends React.Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    ...
    this.props.setTitleText(intl.formatMessage({id: `btn.contents.general.record`}))
  ...
  fetchData(date) {
    ...
    getGeneralHygieneReport(date.getFullYear(), date.getMonth() + 1)
      .then(response => {
      ...
      <div>
            ...
            <div className="gx-flex-row gx-align-items-center gx-mb-4">
              <div
                ...
                <Space>
                  ...
                  <h2 className="gx-w-60"><FormattedMessage id="btn.contents.general.record"/></h2>
                </Space>
              </div>
              <div
                ...
                <Space>
                  <Button className="ant-btn-primary gx-no-margin gx-btn-rounded-blue gx-w-100" onClick={this.onClickPrevMonth}>
                    <FormattedMessage id="btn.prevMonth"/>
                  </Button>
                  <Button className="ant-btn-primary gx-no-margin gx-btn-rounded-blue gx-w-100" onClick={this.onClickNextMonth}>
        ...
        <div className="gx-flex-row gx-align-items-right gx-mb-3">
          ...
          <Button className="ant-btn-primary gx-btn-rounded-blue common-btn-back gx-mr-auto">
            <a
              href={PageConstant.PDF_CONTENTS_GENERAL_HYGIENE + '?year=' + date.getFullYear() + '&month=' + (date.getMonth() + 1)}
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(GeneralHygieneReport))
