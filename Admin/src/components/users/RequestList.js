...
class UserList extends Component {
  ...
  renderSwitch(param) {
    ...
    switch(param) {
      case 0:
        return (
            <span className="label danger">失敗</span>
        )
        break
      case 1:
        return (
            <span className="label success">成功</span>
        )
        break
      case 2:
        return (
            <span className="label warning">進行中</span>
        )
        break
    }
  ...
  render() {
    ...
    const headers = [
      ...
      {
        id: 3,
        title: intl.formatMessage({id: 'table.header.retryCount'})
      },
      {
        id: 4,
        title: intl.formatMessage({id: 'table.header.result'})
      }
    ]
            ...
            {rows.map((row, key) => {
              ...
              return (
                <StyledTableRow
                  ...
                  <StyledTableCell>{row.retryCount}</StyledTableCell>
                  <StyledTableCell>
                    {
                      this.renderSwitch(row.status)
                    }
                  </StyledTableCell>
                </StyledTableRow>
              )
