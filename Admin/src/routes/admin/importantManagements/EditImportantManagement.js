...
import { editImportantManagment, getImportantCategoryList, getImportantManagmentItem } from '../../../api/axiosAPIs'
...
class EditImportantManagement extends Component {
  ...
  componentDidMount() {
    ...
    this.props.setTitleText(intl.formatMessage({id: `page.title.important.management.regist`}))
  ...
  onFinish = (data) => {
    ...
    editImportantManagment(this.selectedId, formData)
      .then(response => {
  ...
  handleCancelBtn = () => {
    this.props.history.push({
      pathname: PageConstant.IMPORTANT_MANAGEMENTS,
  ...
  handleChangeSelect = (value) => {
    ...
    row.important_category_id = item.id
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(EditImportantManagement))